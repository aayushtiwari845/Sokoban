...
$0.484$). Pretrained sequence-modelling machinery does transfer to a domain with
zero shared vocabulary. The cost is $4.0\times$ the parameters ($43.4$M against
$10.7$M) and $6.8\times$ the training time ($4479$\,s against $661$\,s), and the
comparison is single-seed, so we report it as a suggestive ablation rather than
a headline.
